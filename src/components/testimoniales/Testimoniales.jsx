...
import MichielValee from "../../assets/MV.jpeg";
...
const testimonialsList = [
    {
        ...
        image: MichielValee,
        name: "Michiel Valee",
        role:"Cofounder of @Dockflow",
        review: "Ibrahim might be the person with the most most eager drive to learn I have ever met. He was a great addition to our startup dev team, as he always showed up with a smile in our daily stand-ups, also when the challenges were difficult or the environment unknown. We greatly enjoyed the gratefulness and the energy he brings to the team and the dedication and quality standards towards his work. Keeping this learning pace and momentum, he is rapidly becoming a top performer.",
        linkedin: "https://www.linkedin.com/in/michielvalee/",
    },
    {
        id: 2,
        image: YahiaLebbah,
    ...
    },
    {
        ...
        role: "Director of the RIIR laboratory",
        letter: KB,
                ...
                {testimonialsList.map((testimonial, index) => {
                    return (
                        <SwiperSlide key={index} className="testimonial">
                            ...
                            <p className="client__role">{testimonial.role}</p>
